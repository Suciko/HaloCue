...
- [ ] Push the Android source branch and tag `v0.3.0-beta.2`.
- [ ] Publish the GitHub pre-release and independently verify the uploaded APK hash.
...
- GitHub release verification is pending.
