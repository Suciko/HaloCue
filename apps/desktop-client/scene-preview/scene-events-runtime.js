(function (global) {
  ...
  const manifest = {
    ...
    events: [
      ...
      { kind: "halocue.ba:screen-text", descriptor_renderable: true, timeline_supported: true, visual_only: true, duration_policy: "fixed", default_duration_ms: 1800, simple_action: "screen-text", editor_label: "屏幕文字" },
      { kind: "halocue.ba:hit-effect", descriptor_renderable: true, timeline_supported: true, visual_only: true, duration_policy: "fixed", default_duration_ms: 420, simple_action: "hit-effect", editor_label: "中弹效果" },
    ],
  };
