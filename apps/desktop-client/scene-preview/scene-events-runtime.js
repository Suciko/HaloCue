(function (global) {
  ...
  const manifest = {
    ...
    events: [
      ...
      { kind: "halocue.ba:background-pan", descriptor_renderable: true, timeline_supported: true, visual_only: true, supports_non_blocking: false, duration_policy: "fixed", default_duration_ms: 900, simple_action: "background-pan", editor_label: "背景移动" },
      { kind: "halocue.ba:screen-shake", descriptor_renderable: true, timeline_supported: true, visual_only: true, supports_non_blocking: false, duration_policy: "fixed", default_duration_ms: 360, simple_action: "screen-shake", editor_label: "画面震动" },
      { kind: "halocue.ba:screen-text", descriptor_renderable: true, timeline_supported: true, visual_only: true, supports_non_blocking: false, duration_policy: "fixed", default_duration_ms: 1800, simple_action: "screen-text", editor_label: "屏幕文字" },
